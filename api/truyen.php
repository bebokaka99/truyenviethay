...
$subaction = $_GET['subaction'] ?? 'new'; // Mặc định là truyện mới cập nhật
$page = (int)($_GET['page'] ?? 1);
$per_page = ($subaction === 'slider') ? 5 : 18; // 5 truyện cho slider, 18 cho danh sách chính
$offset = ($page - 1) * $per_page;

// Xác định truy vấn dựa trên subaction
if ($subaction === 'slider' || $subaction === 'new') {
    ...
    // Truyện có rating cao nhất
    $sql_count = "SELECT COUNT(*) as total FROM truyen_new WHERE rating > 0";
