    ...
    .then((data) => {
      ...
      if (data.success) {
        ...
        if (userAvatar && data.data.avatar) {
          ...
          const isRootPage = window.location.pathname === "/truyenviethay/" || window.location.pathname.includes("index.html");
          userAvatar.src = isRootPage ? "/truyenviethay/" + data.data.avatar : "../" + data.data.avatar;
        }
      } else {
